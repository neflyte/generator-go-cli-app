# generator-go-cli-app [![NPM version][npm-image]][npm-url] [![Build Status][travis-image]][travis-url] [![Dependency Status][daviddm-image]][daviddm-url]
> Golang CLI app generator
...
```bash
npm install -g yo
npm install -g generator-go-cli-app
```
